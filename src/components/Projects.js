...
const Projects = () => {
    return (
            ...
            <ProjectAttributes>MongoDB, React, Express, JavaScript, Node.js, Mongoose:
Dynamic Full Stack Website</ProjectAttributes> 
            ...
            <ProjectAttributes>React, Node.js, JSX, CSS, MongoDB, Mongoose:<br/> Dynamic Full Stack Website</ProjectAttributes>
            ...
            <ProjectAttributes>JavaScript, CSS, React, MongoDB, Express, Node.js, Mongoose:<br/>Online Gallery</ProjectAttributes>
